<%@ include file="_errorHeader.jspf" %>
<body class="plain error-page-wrapper background-color background-image">
	<div class="content-container">
		...
		<div class="subheader primary-text-color">
			The server encountered an internal error and <br>
		...
		<div class="buttons-container">
			<a class="border-button" href="mailto:johnangolluan@gmail.com" target="_blank">Report A Problem</a>
		</div>
	</div>
	<script>
		...
		var ep = new ErrorPage('body', "500", "plain");
		ep.initialize();
...
<%@ include file="_errorFooter.jspf" %>